...
import { messagePrompts, buttonLabels, fieldLabels } from "../../settings/settings";
        ...
        <AntForm onSubmit={this.onSubmit}>
          <section style={{ marginBottom: 50 }}>
            <AntRow gutter={12}>
              ...
              >
                {getFieldDecorator("ItemListName", {
              ...
              <AntForm.Item
                ...
                className={panelInfo ? null : "hide"}
              >
                {getFieldDecorator("ItemListQuantity", {
                  initialValue: panelInfo.key
                })(<AntInput />)}
              </AntForm.Item>
              ...
              <AntForm.Item
                ...
                className={panelInfo ? null : "hide"}
              >
                {getFieldDecorator("ItemListThreshold", {
                  initialValue: panelInfo.key
                })(<AntInput />)}
              </AntForm.Item>
            </AntRow>
