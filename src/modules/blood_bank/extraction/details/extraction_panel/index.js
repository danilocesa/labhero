  ...
  render() {
	    ...
	    <Card size="small" style={{ backgroundColor: '#E2E2E2', padding: 10, minHeight: 300 }}>
				...
				<Row>
					...
					<Col span={14} className="info-item-text">
						{data.health_info.body_weight} kg
					</Col>
				</Row>
				<Row>
					<Col span={10} className="info-title">
					...
					<Col span={14} className="info-item-text">
						{data.health_info.temperature} C
					</Col>
				</Row>
				<Row>
					<Col span={10} className="info-title">
					...
					<Col span={14} className="info-item-text">
						{data.health_info.blood_pressure} (mmHG)
					</Col>
				</Row>
				<Row>
					<Col span={10} className="info-title">
					...
					<Col span={14} className="info-item-text">
						{data.health_info.pulse_rate} / min
					</Col>
				</Row>
     	</Card>
    );
