				...
				<AntForm onSubmit={this.onSubmit}>
					<section style={{ marginBottom: 50 }}>
						<AntRow gutter={12}>
								...
								<AntForm.Item label={fieldLabels.storage_id} className={panelInfo ? null : "hide"}>
								...
								<AntForm.Item label={fieldLabels.storage_name} className={panelInfo ? null : "hide"}>
								...
								<AntForm.Item label={fieldLabels.storage_details}>
									{getFieldDecorator('storage_details', {
